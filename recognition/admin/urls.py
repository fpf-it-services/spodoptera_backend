...
urlpatterns = [
    ...
    path(
        "get_user_images/<int:user_id>/", views.get_user_images, name="get_user_images"
    ),
    ...
    path(
        "measures/update/<int:measure_id>/", views.update_measure, name="update_measure"
    ),
    path(
        "measures/delete/<int:measure_id>/", views.delete_measure, name="delete_measure"
    ),
