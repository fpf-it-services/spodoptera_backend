...
class UserProfile(models.Model):
    ...
    is_admin = models.BooleanField(
        default=False, help_text="Indique si l'utilisateur est un administrateur"
    )
...
class Observation(models.Model):
    ...
    zone_agro = models.ForeignKey(
        ZoneAgro, on_delete=models.SET_NULL, null=True, blank=True
    )
...
class CorrectiveMeasure(models.Model):
    ...
    order = models.PositiveIntegerField(
        null=True, blank=True, help_text="Ordre d'affichage des mesures"
    )
