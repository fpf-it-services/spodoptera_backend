...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        if not User.objects.filter(username='johndoe@example.com').exists():
            ...
            self.stdout.write(self.style.SUCCESS('Successfully created default johndoe@example.com'))
        ...
        if not User.objects.filter(username='janesmith@example.com').exists():
            ...
            self.stdout.write(self.style.SUCCESS('Successfully created default janesmith@example.com'))